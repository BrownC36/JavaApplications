//Exercise 13.31 Solution : DrawFrame
//Program that creates a panel for the user ot draw shapes
...
public class DrawFrame extends JFrame implements ItemListener, ActionListener
{
    ...
    private JComboBox<String> shapeChoices; //combo box for selecting shape
    ...
    private JCheckBox gradientCheckBox; //check box to toggle filled shapes
